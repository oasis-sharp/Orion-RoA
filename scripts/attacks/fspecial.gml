...
set_attack_value(AT_FSPECIAL, AG_AIR_SPRITE, sprite_get("parry"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("oilProj"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("oilProj"));
