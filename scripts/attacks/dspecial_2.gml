set_attack_value(AT_DSPECIAL_2, AG_SPRITE, sprite_get("dtilt"));
set_attack_value(AT_DSPECIAL_2, AG_NUM_WINDOWS, 3);
set_attack_value(AT_DSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("dtilt_hurt"));
...
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_HAS_WHIFFLAG, 6);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_WIDTH, 122);
