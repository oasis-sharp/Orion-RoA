...
with phone{
	...
	initTip("NSpecial: Spanner throw");
	initTipWords("You can hold the spanner in your hand to halt momentum or aim, but this doesn't change how strong it is. This attack always knocks towards the opponent!");
	initTipImage(player_id.spr_spanner, 3, fa_center, 1, c_white, 0);
...
with phone{
	...
	initAbout("About Orion", "Custom character by Oasis
	
	[Credits]
	gh0st.p3pp3r - spriting
	RoAExtW - helping a lot. join the server. now.
...
if pho_has_steve_dmsg{
	...
	steve_death_message = "Steve was hit in the face with a spanner";
